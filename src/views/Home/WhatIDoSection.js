        ...
        <Row display="has-text-centered row-m">
          <Column>
            <div className="what-ido-div">
              ...
              <p>Move fast and ship robust and reliable solutions.</p>
            </div>
          </Column>
          <Column>
            <div className="what-ido-div">
              ...
              <p>
                Though-out UI and UX that leads to a responsive products that
                work.
              </p>
            </div>
          </Column>
          <Column>
            <div className="what-ido-div">
              <h3> Designer</h3>
              <p>
                With a background in Fine Arts, good design is part of who I am.
              </p>
            </div>
          </Column>
        </Row>
