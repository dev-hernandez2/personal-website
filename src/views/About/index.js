      ...
      >
        ...
        <div className="row-m about-body">
          <p className="regular">
            ...
            life dilemmas. I love building Digital Products from start to fnish,
            and been doing so for the last eight years.
          </p>
          <p className="regular">
            With a background in Fine Arts, design has shown to be an extension
            of who I am. Having experiences in both felds has allowed me to
            excel in my professional life. I love great challenges and am always
            willing to learn new things, is all just part of my adventurous
            journey.
          </p>
          <p className="regular">
            ...
            for new opportunities. I understand there is always a better way to
            do things and our work can always (and should always) improve.
          </p>
          <p className="regular">
